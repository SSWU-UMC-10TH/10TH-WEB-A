    ...
    return (
        <nav className="fixed top-0 w-full flex justify-between items-center p-4 bg-[#121212] z-[51] text-white border-b border-gray-800">
            <div className="flex items-center gap-4">
                ...
                <Link
                    to="/"
                    className="text-2xl font-bold text-pink-500 no-underline"
                >
                    돌려돌려LP판
                </Link>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                {!accessToken ? (
                    <div className="flex gap-4 items-center">
                        ...
                        <Link
                            to="/signup"
                            className="px-4 py-1 bg-pink-500 text-white rounded-md font-bold"
                        >
                            회원가입
                        </Link>
                    </div>
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button
                            ...
                            disabled={isPending}
                            className="hover:text-pink-500 cursor-pointer disabled:opacity-50"
                        >
